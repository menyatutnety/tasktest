<form onsubmit="return false;" id="sign_up_form">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="signUpForm[login]" placeholder="введите ваше логин">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <input type="email" class="form-control" name="signUpForm[email]" placeholder="введите ваше имя">
    </div>
    <div class="form-group">
        <input type="text" class="form-control" name="signUpForm[name]" placeholder="введите ваш email">
    </div>
